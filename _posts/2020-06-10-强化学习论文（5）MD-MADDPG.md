...
MD-MADDPG; actor-critic; off-policy; model-free; continuous communication channel; continuous action space; continuous state space; cooperative task;
...
<img width="50%" src="/img/in-post/2020-06-10-强化学习论文（5）MD-MADDPG.assets/image-20200610111745554.png"/>



- b）Read operation：读取 memory device 的存储信息并通过 $e$ 提取有效信息得到 $r$

<img width="80%" src="/img/in-post/2020-06-10-强化学习论文（5）MD-MADDPG.assets/image-20200610111831289.png"/>
...
<img width="50%" src="/img/in-post/2020-06-10-强化学习论文（5）MD-MADDPG.assets/image-20200610112108902.png"/>

<img width="70%" src="/img/in-post/2020-06-10-强化学习论文（5）MD-MADDPG.assets/image-20200610112600723.png"/>
