...
<img width="50%" src="/img/in-post/2020-06-04-强化学习论文（1）MADDPG.assets/image-20200604154346760.png"/>
...
<img width="50%" src="/img/in-post/2020-06-04-强化学习论文（1）MADDPG.assets/image-20200604155552391.png"/>



4、Critic 网络的损失函数定义如下

<img width="50%" src="/img/in-post/2020-06-04-强化学习论文（1）MADDPG.assets/image-20200604155626317.png"/>
...
<img width="50%" src="/img/in-post/2020-06-04-强化学习论文（1）MADDPG.assets/image-20200604161556518.png"/>
...
<img width="50%" src="/img/in-post/2020-06-04-强化学习论文（1）MADDPG.assets/image-20200604161155865.png"/>



接着每个智能体便可以近似地计算所需要的 $y$ 值

<img width="50%" src="/img/in-post/2020-06-04-强化学习论文（1）MADDPG.assets/image-20200604161304850.png"/>



2、可以采用策略集成的方法来得到更鲁棒的策略，即每个智能体都单独训练 $k$ 不同个子策略，在每次需要选择动作时可以随机选择一个子策略来选择动作，其 Actor 网络的梯度定义如下

<img width="50%" src="/img/in-post/2020-06-04-强化学习论文（1）MADDPG.assets/image-20200604161945936.png"/>
