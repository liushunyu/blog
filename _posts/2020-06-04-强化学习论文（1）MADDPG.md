...
MADDPG; actor-critic; off-policy; model-free; continuous communication channel; continuous action space; continuous state space; mixed task; cooperative task; competitive task;
