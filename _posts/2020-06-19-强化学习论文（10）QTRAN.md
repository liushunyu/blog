...
QTRAN; value-based; off-policy; model-free; discrete action space; continuous state space; cooperative task; credit assignment; centralized training with decentralized execution; value function factorization;
...
<img width="100%" src="/img/in-post/2020-06-19-强化学习论文（10）QTRAN.assets/image-20200622104350499.png"/>
...
<img width="60%" src="/img/in-post/2020-06-19-强化学习论文（10）QTRAN.assets/image-20200622112412553.png"/>
