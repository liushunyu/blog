...
6、此外为了解决 Hysteretic Q-learning 中初期状态动作对降温速度过快的问题，提出了 Scheduled-HDQN，但感觉这里不太对，按照公式写的初始状态的温度衰减貌似更快了。
...
1、从实验结果上看，在 Original 和 Narrow-Passgae 环境中感觉没有比 HDQN 效果好多少，而且训练时间还要求更久，在 Stochastic Reward 中效果较佳。
